...
<%@include file="cssFilesSpring.html"%>
</head>
<body>
			...
			<div class="container">
						...
						<div class="form-one">
							<form action="">
								<input type="text" placeholder="Email*"
									value="${customer.email}"> <input type="text"
									placeholder="Title" value=""> <input type="text"
									placeholder="First Name *" value="${customer.first_Name}">
								<input type="text" placeholder="Last Name *"
									value="${customer.last_Name }"> <input type="text"
				...
				<div class="payment-options">
					<span> <label><input type="checkbox"> Direct
							Bank Transfer</label> </span> <span> <label><input
							type="checkbox"> Check Payment</label> </span> <span> <label><input
							type="checkbox"> Paypal</label> </span>
				</div>
	...
	<jsp:include page="jsFilesSpring.html"></jsp:include>
</body>
</html>