		...
		<div id="bd" class="yui-t6">
			...
			<div id="yui-main">
				<div class="yui-b">
					...
					<jsp:include page="../../view/carttable.jsp"/>
					...
					<table>
						<c:forEach var="product" items="${recommendations}">
							<tr>
								<td><img class="product-thumb" src="${imagesPath}/${product.imagel}" alt="${product.product_Name}" /></td>
			...
			<div class="yui-b">
				...
				<jsp:include page="../../view/account/loginbox.jsp"/>
